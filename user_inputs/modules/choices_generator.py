...
def generate_year_choices(source: str, raw_data_dir: str = None):
...
def generate_state_choices(source: str, year: str, chamber: str, raw_data_dir: str = None):
...
def generate_district_choices(source: str, year: str, chamber: str, state: str, raw_data_dir: str = None):
...
def generate_candidate_choices(year: str, chamber: str, state: str, raw_data_dir: str, district: str = None):
