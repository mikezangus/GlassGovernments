...
def output_year_list(action: str, source: str, raw_data_dir: str = None):
    year_choices_list = generate_year_choices(source, raw_data_dir)
...
def output_state_list(action: str, source: str, year: str, chamber: str, raw_data_dir: str = None):
    state_choices_list = generate_state_choices(source, year, chamber, raw_data_dir)
...
def output_district_list(action: str, source: str, year: str, chamber: str, state: str, raw_data_dir: str = None):
    district_choices_list = generate_district_choices(source, year, chamber, state, raw_data_dir)
...
def output_candidate_list(action: str, year: str, chamber: str, state: str, raw_data_dir: str, district: str = None):
    candidate_choices_list = generate_candidate_choices(year, chamber, state, raw_data_dir, district)
